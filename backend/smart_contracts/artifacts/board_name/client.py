...
class BoardNameClient:
    """A class for interacting with the board_name app providing high productivity and
    ...
    def __init__(
        ...
        *,
        ...
        """
        BoardNameClient can be created with an app_id to interact with an existing application, alternatively
