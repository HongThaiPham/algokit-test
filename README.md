...
The frontend starter also provides an example of interactions with your BoardNameClient in [`AppCalls.tsx`](frontend/src/components/AppCalls.tsx) component by default.
